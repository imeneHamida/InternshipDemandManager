...
urlpatterns = [
    ...
    path('othersSignin/', views.othersSignin ,name="othersSignin"),
    path('Deleteaccount/', views.delete_account ,name="deleteAccount"),
    #path('StudentInfo/<str:pk>/', views.StudentInfo ,name="StudentInfo"),
    path('ViewPresence/<str:pk>/', views.ViewPresence, name='ViewPresence'),
    path('ViewMarks/<str:pk>/', views.ViewMarks, name='ViewMarks'),
    path('ViewNewAccounts/', views.ViewNewAccounts, name='ViewNewAccounts'),
    path('ApproveAccount/<str:pk>/', views.ApproveAccount, name='ApproveAccount'),
